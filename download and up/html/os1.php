...
<section class="heading">
    <h3>OS1</h3>
    <p> <a href="./course-2.php">Courses >></a> OS1 </p>
</section>
<div class="wrapper">
    <header>File Uploader</header>
    <form action="os1.php" method="post" enctype="multipart/form-data" >
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="os1.php?file_id=<?php echo 
