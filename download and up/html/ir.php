...
<section class="heading">
    <h3>IR</h3>
    <p> <a href="./course-2.php">Courses >></a> IR </p>
</section>
<div class="wrapper">
    <header>File Uploader</header>
    <form action="ir.php" method="post" enctype="multipart/form-data" >
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="ir.php?file_id=<?php echo 
